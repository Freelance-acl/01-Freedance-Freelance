...
public class ProposalAnalyticsDashboardDTO {
    ...
    public double getAverageEstimatedDays() {
        return averageEstimatedDays;
    }

    public Map<String, Long> getProposalsByStatus() {
    ...
    public static final class Builder {
        ...
        private double averageBidAmount;
        private double averageEstimatedDays;
        private Map<String, Long> proposalsByStatus = Map.of();
